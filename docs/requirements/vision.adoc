...
Ein Bar-betreiber möchte in den Onlinemarkt expandieren. Die Software soll den Kunden die möglichkeit geben eine selbstgewählte Menge von bestehenden oder selbstkreierten Cocktails einfach und Kundenfreundlich zu Bestellen und sich direkt nach Hause Liefern zu lassen. Es muss ein Warenkorb vorhanden sein, die möglichkeit zur Stornierung, die möglichkeit zur erstellung und nutzung eines Kundenkontos müssen vorhanden sein, sowie ein System zur Sperrung von nicht Zahlenden Kunden.
...
|   Das Problem | Expansion des Geschäfts
|   betrifft    | den Geschäftführer, Kunden, Lieferanten
...
|   Mitarbeiter
|   wird bezahl
|   bedient Kunden, mischt Cocktails

|   IT-Ulli
|   Erschafft das System
|   Funktionsfähigkeit des Produkts

|   Deutschland
|   Ist Stakeholder durch Alkoholgesetze
|   Legaler und regulierter Konsum von Alkohol

|   Lieferant
|   Liefert materiallien für die Produktion
|   Pünktliche Lieferung der richtigen Menge

|   Auslieferer
|   Lieferung der Bestellten Cocktails zur gewünschten Addresse
|   Lieferung der Ware in der richtigen Menge, Qualität und zur richtigen Zeit
